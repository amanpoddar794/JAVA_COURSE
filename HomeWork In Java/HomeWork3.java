...
public class HomeWork3 {
    public static void main(String[] args) {
        ...
        //Q1. Print the spiral order matrix as output for a given matrix of numbers.
                // Ex- Spiral order is given by: 1 5 7 9 10 11 21 41 70 105 95 81 79 70 40 15 9 6 10 12 13 20 32 68 63 59 55 25 29 30 29.
            ...
            //Ans-
                ...
                //         //Loop for Input
                //         //rows
                // System.out.println("Enter your input for array " + n + " rows and " + m +" columns: ");
                // for (int i = 0; i < n; i++){
                //         //Column
                //     for(int j = 0; j < m; j++){
