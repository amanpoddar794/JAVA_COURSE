...
public class HomeWork {
  public static void main(String[] args) {
    ...
    // boolean hasLicense = false; // False if the person doesn't have a driving
    // license
    ...
    // BigDecimal accountBalance = new BigDecimal("1234567.89"); // Stores precise
    // monetary values
    ...
    // Q3.Make a program that prints the table of a number that is input by the
    // user.
    ...
    // Q1.Make a Calculator. Take 2 numbers (a & b) from the user and an operation
    // as follows :
    // 1 : + (Addition) a + b
    // 2 : - (Subtraction) a - b
    ...
    // Q2. Ask the user to enter the number of the month & print the name of the
    // month.
    ...
    // // System.out.println("Because your marks don't matter but your effort
    // does.");
    // System.out.println();
    // }else{
    // System.out.println("Invalid Marks. Please enter a number between 0 and
    // 100.");
    // System.out.println();
    // }
    ...
    // Bonus Question. Print Pascal's Triangle with numbers.
